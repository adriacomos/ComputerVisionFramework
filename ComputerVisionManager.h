...
namespace cvfn {
	...
	public:
		...
		#ifdef DECKLINK
			virtual void startVideoProcessorFromDecklinkDevice( Size2D^ captureSize, bool resizeFrame, Size2D^ resizeFrameSize );
		#endif
		...
		virtual	void setCCFeatureTracker(	Rect^ areaTracking,
											unsigned int minPoints,
											bool activateSBD );
		// <-------------------------------------------------------------------------
